<template>
    <div class="vc_row wpb_row vc_row-fluid vc_custom_1625512963830">
            ...
            <div class="vc_column-inner">
                <div class="wpb_wrapper">
                    ...
                    <div class="wpb_text_column wpb_content_element ">
                        <div class="wpb_wrapper">
                            <h1>
                                <span style="color: #269aff;"><span style="color: #000000;">Últimas</span> Motos</span>
                            </h1>
                        </div>
                    </div>
                                                        ...
                                                        <div class="vc_col-sm-8 vc_gitem-col vc_gitem-col-align-">
                                                            <div
                                                                ...
                                                                <h3 style="font-size: 20px;color: #000000;text-align: left;font-family:Open Sans;font-weight:600;font-style:normal">
                                                                    <a href="listings/kawasaki-kawasaki-vn-900-2013/index.html"
                                                                       class="vc_gitem-link"
                                                                       title="Kawasaki Kawasaki VN 900 2013">Kawasaki
                                                                        Kawasaki
                                                        ...
                                                        <div class="vc_col-sm-8 vc_gitem-col vc_gitem-col-align-">
                                                            <div
                                                                ...
                                                                <h3 style="font-size: 20px;color: #000000;text-align: left;font-family:Open Sans;font-weight:600;font-style:normal">
                                                                    <a href="listings/honda-honda-crf-250-rx-2020/index.html"
                                                                       class="vc_gitem-link"
                                                                       title="Honda Honda CRF 250 RX 2020">Honda
                                                        ...
                                                        <div class="vc_col-sm-8 vc_gitem-col vc_gitem-col-align-">
                                                            <div
                                                                ...
                                                                <h3 style="font-size: 20px;color: #000000;text-align: left;font-family:Open Sans;font-weight:600;font-style:normal">
                                                                    <a href="listings/suzuki-suzuki-dr650s-2021/index.html"
                                                                       class="vc_gitem-link"
                                                                       title="Suzuki Suzuki DR650S 2021">Suzuki
                                                                        Suzuki DR650S 2021</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div
