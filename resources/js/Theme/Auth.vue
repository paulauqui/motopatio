<template>
    <a href="#" @click="redirectPage('voyager.profile')" class="settings">
    ...
    <ul class="account-list">
        <li>
            <a href="#" @click="redirectPage('voyager.motorcycle.index')">
                Mis motos
            </a>
        </li>
        <li class="stm-my-favourites">
            <a @click="redirectPage('voyager.motorcycle.index')"
               href="#">
